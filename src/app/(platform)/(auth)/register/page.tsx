...
const RegisterFormSchema = z.object({
    ...
    lastname: z.string().min(2, {
        message: "Last name must conatin atleast 2 characters",
    }),
            ...
            <div className='w-[40%] hidden md:flex items-center justify-center'>
              <div className='w-[90%] mt-10  text-white space-y-3'>
                <h1 className='text-5xl font-bold'>
                  Connect with people <span className=' text-[#BBC2CC]'>seamlessly,</span>{' '}
                </h1>
                <h4 className='text-2xl'>let your post meet your audience</h4>
                <Image
                  src={'/task2.svg'}
                  alt='task'
                  width={500}
