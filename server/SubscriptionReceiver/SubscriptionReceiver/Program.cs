...
async Task MessageHandler(ProcessMessageEventArgs args)
{
    ...
    Console.WriteLine($"Received: {body} from subscription: mysubscription");
...
processor = client.CreateProcessor("mytopic", "mysubscription", new ServiceBusProcessorOptions());
